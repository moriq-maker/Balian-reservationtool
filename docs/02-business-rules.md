...
初期55室(301〜308, 401〜410, 501〜510, 601〜610, 701〜710, 801〜804, 901〜903)をマスターとして管理する。検索可能なセレクトUIで選択する。将来的な追加・無効化に対応するため、ハードコードせずテーブルで管理する。無効化された部屋番号は新規予約の選択肢から除外するが、過去予約の表示は維持する(施設マスターと同じ論理削除方針)。
